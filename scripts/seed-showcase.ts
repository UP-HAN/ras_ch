...
// ---------- 문장 재료 (초등 6학년 말투) ----------
const BODIES = [
  '이번 주에는 유튜브를 제일 많이 봤어요. 숙제를 끝내고 잠깐만 보려고 했는데 다음 영상이 자동으로 나와서 한 시간이 훌쩍 지나갔어요. 다음 주에는 자동 재생을 끄고 저녁에는 폰을 거실에 두기로 했어요. 대신 동생이랑 보드게임을 하기로 약속했어요.',
  '게임 시간이 지난주보다 조금 줄었어요. 친구들이랑 같이 하다 보면 멈추기가 어려운데, 엄마랑 정한 타이머가 울리면 끄기로 했더니 지킬 수 있었어요. 다음 주에는 주말에만 게임을 하고 평일에는 줄넘기를 할 거예요.',
  '카톡 알림이 자꾸 와서 폰을 계속 보게 됐어요. 그래서 공부할 때는 방해금지 모드를 켰어요. 처음에는 답장을 못 해서 불안했는데 나중에 한꺼번에 보내도 괜찮았어요. 다음 주에도 방해금지 모드를 꼭 쓰겠어요.',
  '이번 주는 폰을 거의 안 썼어요. 할머니 댁에 가서 밭일을 도와드리고 저녁에는 별을 봤어요. 폰이 없어도 심심하지 않다는 걸 알았어요. 다음 주에는 학교 끝나고 도서관에서 책을 한 권 다 읽는 게 목표예요.',
  '웹툰을 많이 봤어요. 하루에 30분만 보기로 했는데 새로 나온 회차가 많아서 계속 봤어요. 대신 잠들기 전에는 안 보려고 폰을 충전기에 꽂고 방 밖에 뒀어요. 다음 주에는 웹툰 보는 시간을 정해 두고 지킬 거예요.',
  '동영상 보는 시간을 줄이려고 알림을 껐더니 정말 덜 보게 됐어요. 남는 시간에 그림을 그렸는데 생각보다 재미있었어요. 다음 주 목표는 하루 평균 사용시간을 두 시간 아래로 만드는 거예요.',
  '학원 끝나고 버스에서 쇼츠를 계속 넘기다가 내릴 정류장을 지나칠 뻔했어요. 그날부터 버스에서는 폰을 가방에 넣고 창밖을 봤어요. 생각보다 볼 게 많았어요. 다음 주에는 이동할 때 폰을 꺼내지 않는 걸 목표로 해요.',
  '주말에 가족이랑 캠핑을 가서 폰이 잘 안 터졌어요. 처음엔 답답했는데 불 피우고 감자 굽는 게 훨씬 재밌었어요. 평일에는 숙제 끝나고 게임을 한 시간 했어요. 다음 주에는 게임을 40분으로 줄여 볼 거예요.',
  '친구들이랑 단톡방에서 밤늦게까지 이야기하다가 아침에 늦게 일어났어요. 그래서 밤 10시에는 폰을 엄마한테 맡기기로 했어요. 이틀은 실패했지만 나머지는 지켰어요. 다음 주에는 일주일 내내 지키고 싶어요.',
  '이번 주에는 사용시간이 늘었어요. 새로 나온 게임 때문이에요. 솔직히 조절이 잘 안 됐어요. 그래도 리포트를 쓰면서 얼마나 했는지 눈으로 보니까 놀랐어요. 다음 주에는 게임 전에 알람을 맞추고 시작하겠어요.',
  '축구 연습 때문에 폰 볼 시간이 별로 없었어요. 저녁에는 피곤해서 바로 잤어요. 몸을 움직이면 폰 생각이 덜 난다는 걸 느꼈어요. 다음 주에도 방과 후 운동을 세 번 하고 사용시간을 지금처럼 유지하는 게 목표예요.',
  '동생이랑 폰 없이 하루 보내기 내기를 했어요. 내가 이겼어요! 그날은 종이접기랑 퍼즐을 했어요. 다른 날은 평소처럼 봤지만 하루라도 안 보니까 자신감이 생겼어요. 다음 주에는 이틀 도전할 거예요.',
];
const DIARIES = [
  '이번 주는 폰 없이 지냈어요. 처음에는 친구들 소식이 궁금했는데 학교에서 직접 물어보니까 더 재미있었어요. 저녁에는 가족이랑 산책을 했어요. 다음 주에도 폰 없이 밖에서 노는 날을 세 번은 만들고 싶어요.',
  '폰 대신 책을 읽었어요. 도서관에서 빌린 추리 소설이 너무 재미있어서 하루 만에 다 읽었어요. 폰이 없으니 밤에 잠도 일찍 잤어요. 다음 주에는 과학책도 한 권 읽어 볼 생각이에요.',
  '폰 없이 지내면서 그림일기를 다시 쓰기 시작했어요. 하루에 한 장씩 그리니까 일주일이 어떻게 지나갔는지 잘 보였어요. 다음 주에는 색연필로 색칠까지 해서 친구들에게 보여 주고 싶어요.',
  '이번 주에는 엄마 폰으로 급한 연락만 했어요. 심심할 때는 줄넘기를 했는데 이제 이중 뛰기가 열 번 돼요. 다음 주에는 스무 번을 목표로 연습할 거예요.',
];
const GOALS = [
  '저녁 9시 이후 폰 안 보기',
  '하루 30분 줄이기',
...
/** 찬성·반대 접두사를 떼고, 일부에만 다양한 말투로 다시 붙인다 (배지가 이미 입장을 보여 준다) */
const STANCE_PREFIX = {
  agree: ['저는 찬성이에요. ', '찬성! ', '저도 찬성 쪽이에요. ', '찬성하는 편이에요. '],
  disagree: ['저는 반대예요. ', '반대! ', '저는 반대 쪽이에요. ', '반대하는 편이에요. '],
} as const;
const STANCE_SUFFIX = {
  agree: [' 그래서 찬성이에요.', ' 그래서 저는 찬성 쪽이에요.'],
  disagree: [' 그래서 반대예요.', ' 그래서 저는 반대 쪽이에요.'],
} as const;
function naturalize(text: string, side: 'agree' | 'disagree', i: number): string {
  const body = text
    .replace(/^(나는 |저는 |내 생각에는 )?(찬성|반대)(해요|이에요|예요|입니다)\.\s*/u, '')
    .trim();
  const first = body;
  const k = i % 7;
  if (k === 0) return STANCE_PREFIX[side][i % STANCE_PREFIX[side].length] + first;
  if (k === 3) return first + STANCE_SUFFIX[side][i % STANCE_SUFFIX[side].length];
  return first;
}
...
const ARTICLES = [
  {
    title: '토요 스포츠데이 배구 결승전, 끝까지 포기하지 않았어요',
    type: 'coverage',
    tags: ['S', 'A'],
    oneLine: '다음에도 꼭 참가하고 싶어요',
    body: '지난 토요일 운동장에서 스포츠데이 배구 결승전이 열렸어요. 6학년 3반과 6학년 5반이 맞붙었고, 학생들이 직접 심판과 기록을 맡았어요. 서브가 넘어갈 때마다 응원 소리가 커졌고 마지막 세트는 듀스까지 갔어요. 결국 5반이 이겼지만 3반도 끝까지 포기하지 않아서 모두 박수를 받았어요. 다음 스포츠데이에는 피구 경기도 열린다고 해요. 체육 선생님은 "규칙을 지키며 즐기는 모습이 가장 좋았다"고 말씀하셨어요. 경기가 끝난 뒤에는 양 팀이 악수를 하고 함께 사진을 찍었어요.',
  },
  {
    ...
    body: '사서 선생님께 달빛 도서관 행사에 대해 여쭤보았어요. 달빛 도서관은 저녁에 도서관 불을 은은하게 켜고 책을 읽는 행사예요. 선생님은 "폰 대신 책과 친해지는 시간을 만들고 싶었다"고 하셨어요. 참가한 친구들은 손전등으로 책을 읽는 게 신기했다고 말했어요. 다음 달에는 다른 학년도 참가할 수 있다고 해요. 신청은 도서관 앞 게시판에서 할 수 있어요. 책을 좋아하는 친구들에게 꼭 추천하고 싶어요. 선생님은 마지막으로 "한 권을 끝까지 읽는 경험이 중요하다"고 덧붙이셨어요.',
  },
  {
    ...
    body: '우리 반은 지난주 수요일에 폰 없는 하루 챌린지를 했어요. 아침에 폰을 담임 선생님께 맡기고 하루를 보냈어요. 처음에는 손이 심심했는데 점심시간에 친구들이랑 공기놀이를 하니까 시간이 금방 갔어요. 집에 가서도 폰을 안 보고 그림을 그렸어요. 저녁에 엄마가 "오늘 표정이 밝다"고 하셨어요. 다음에는 이틀 연속으로 도전해 보고 싶어요. 친구들도 꼭 한번 해 보면 좋겠어요. 반 친구 스물 몇 명이 다 같이 하니까 혼자 할 때보다 훨씬 쉬웠어요.',
  },
  {
    title: '미술실에서 만난 우리 학교 벽화 이야기',
    type: 'coverage',
    tags: ['A'],
    oneLine: '우리가 그린 그림이 학교에 남아요',
    body: '3층 복도에 새 벽화가 생겼어요. 미술부 친구들이 3주 동안 방과 후에 그린 거예요. 주제는 "폰을 내려놓고 바라본 우리 동네"예요. 벽화에는 놀이터, 도서관, 강가에서 노는 아이들이 그려져 있어요. 미술부 부장은 "친구들이 지나가다 멈춰서 보는 게 제일 기쁘다"고 말했어요. 미술 선생님은 다음 벽화 주제를 학생들이 투표로 정하게 하겠다고 하셨어요. 벽화 앞에서 사진을 찍는 친구들이 많아졌어요.',
  },
  {
    title: '독서 동아리 "책벌레" 회장을 만났어요',
    type: 'interview',
    tags: ['R'],
    oneLine: '한 달에 두 권이면 충분해요',
    body: '독서 동아리 책벌레 회장 친구를 인터뷰했어요. 책벌레는 매주 금요일 점심시간에 도서관에서 모여 읽은 책을 소개해요. 회장은 "처음엔 책이 지루했는데 친구가 추천한 만화책부터 시작했다"고 했어요. 지금은 한 달에 두 권씩 읽어요. 폰 보는 시간이 줄었냐고 묻자 "책 읽다 보면 폰 생각이 안 난다"고 답했어요. 동아리는 새 회원을 언제든 받아요. 도서관 앞에 신청서가 있어요.',
  },
  {
    title: '점심시간 운동장 축구 리그 개막',
    type: 'coverage',
    tags: ['S'],
    oneLine: '반 대항전이 제일 재밌어요',
    body: '이번 주부터 점심시간 반 대항 축구 리그가 시작됐어요. 6학년 여덟 반이 두 조로 나뉘어 경기해요. 첫 경기는 1반과 4반이었는데 2대 2로 비겼어요. 골키퍼를 맡은 친구는 "공이 무서웠는데 막고 나니까 자신감이 생겼다"고 말했어요. 체육 선생님은 심판을 학생이 맡게 해서 규칙을 스스로 배우게 했어요. 경기가 있는 날에는 운동장에 폰을 들고 나오는 친구가 거의 없었어요. 리그는 10월까지 이어져요.',
  },
  {
    title: '하루 30분 줄이기, 우리 반 2주 도전기',
    type: 'review',
    tags: ['phonefree'],
    oneLine: '같이 하니까 되더라고요',
    body: '우리 반은 2주 동안 하루 사용시간 30분 줄이기를 함께 했어요. 매일 아침 칠판에 어제 사용시간을 적었어요. 첫 주에는 절반만 성공했는데 둘째 주에는 스무 명 넘게 성공했어요. 제일 많이 줄인 친구는 하루 두 시간을 줄였어요. 비결은 알림 끄기와 자기 전 폰 거실에 두기였어요. 담임 선생님은 "숫자를 보니까 스스로 조절하게 된다"고 하셨어요. 다음에는 3주 도전을 하기로 했어요.',
  },
  {
    title: '가을 음악회 준비 현장',
    type: 'coverage',
    ...
    body: '10월 가을 음악회를 앞두고 음악실이 바빠졌어요. 6학년은 리코더 합주와 합창을 준비해요. 연습은 매주 화요일과 목요일 방과 후에 해요. 지휘를 맡은 친구는 "박자가 안 맞을 때가 제일 어렵다"고 했어요. 음악 선생님은 폰을 보며 연습하는 대신 서로 소리를 들으라고 하셨어요. 연습이 끝나면 간식을 나눠 먹어요. 음악회는 10월 셋째 주 금요일 강당에서 열려요.',
  },
  {
    title: '폰 대신 보드게임, 쉬는 시간이 달라졌어요',
    type: 'review',
    tags: ['phonefree', 'A'],
    oneLine: '루미큐브 고수가 되고 싶어요',
    body: '자치회에서 교실마다 보드게임을 나눠 준 뒤 쉬는 시간이 달라졌어요. 우리 반에서는 루미큐브와 할리갈리가 제일 인기예요. 전에는 쉬는 시간에 자리에서 폰을 보는 친구가 많았는데 지금은 책상을 붙여 놓고 게임을 해요. 게임에서 지면 아쉽지만 다음 판이 더 기다려져요. 한 친구는 "폰 게임보다 친구 얼굴 보면서 하는 게 재밌다"고 했어요. 자치회는 다음 달에 새 게임을 더 준다고 해요.',
  },
  {
    ...
    tags: ['R', 'A'],
    oneLine: '고구마가 이렇게 커요',
    body: '학교 텃밭에서 고구마와 배추를 수확했어요. 봄에 심은 고구마가 어른 주먹만큼 자랐어요. 6학년은 반별로 고랑을 맡아 캤어요. 흙이 묻어도 아무도 폰을 꺼내지 않고 열심히 캤어요. 수확한 고구마는 급식실에서 쪄서 나눠 먹었어요. 텃밭 담당 선생님은 "기다림의 맛"이라고 하셨어요. 배추는 11월 김장에 쓸 예정이에요. 다음 주에는 텃밭 일기를 쓰는 시간이 있어요.',
  },
  {
    ...
    tags: ['phonefree'],
    oneLine: '자기 전엔 거실에!',
    body: '첫째, 자기 전에는 폰을 거실에 둬요. 둘째, 공부할 때는 방해금지 모드를 켜요. 셋째, 자동 재생은 꺼요. 이 세 가지만 지켜도 하루 한 시간이 생겨요.',
  },
  {
    title: '미술관 견학, 그림 앞에서 멈춰 선 시간',
    type: 'review',
    tags: ['A'],
    oneLine: '사진 대신 눈으로 담았어요',
    body: '지난주 목요일 시립미술관에 견학을 갔어요. 선생님은 사진을 찍기 전에 그림을 1분 동안 보라고 하셨어요. 처음엔 길게 느껴졌는데 자세히 보니 그림 속에 숨은 고양이가 보였어요. 폰으로 찍기만 했으면 못 봤을 거예요. 제일 기억에 남는 작품은 바다를 그린 큰 그림이었어요. 견학 뒤에는 각자 좋아하는 그림을 따라 그렸어요. 다음에는 가족과 다시 가고 싶어요.',
  },
  {
    ...
    body: '급식실 영양 선생님을 찾아가 채소 반찬이 자주 나오는 이유를 여쭤보았어요. 선생님은 "자라는 몸에는 골고루 먹는 게 제일 중요하다"고 하셨어요. 제일 인기 없는 반찬은 나물이고 제일 인기 있는 반찬은 닭강정이라고 해요. 잔반이 줄어들면 급식실에서 특별 메뉴를 준비한다는 약속도 받았어요. 선생님은 "한 입만 먼저 먹어 보라"는 말을 꼭 전해 달라고 하셨어요. 다음 달에는 학생들이 메뉴를 제안하는 날도 생긴다고 해요.',
  },
  {
    ...
    tags: ['S'],
    oneLine: '레이업 성공!',
    body: '이번 주부터 체육관에서 방과 후 농구 교실이 시작됐어요. 6학년 스물네 명이 신청했고 코치 선생님 두 분이 가르쳐 주세요. 첫 시간에는 드리블과 패스를 배웠어요. 공을 놓치는 친구가 많았지만 아무도 웃지 않고 다시 주워 줬어요. 마지막에는 레이업 슛 연습을 했는데 처음 성공한 친구가 크게 소리를 질렀어요. 코치 선생님은 "폰 대신 공을 잡는 시간이 늘면 키도 큰다"고 농담하셨어요. 수업은 매주 화·목요일이에요.',
  },
  {
    ...
    tags: ['phonefree'],
    oneLine: '밥이 더 맛있었어요',
    body: '우리 반은 일주일 동안 점심시간에 폰을 사물함에 넣어 두기로 했어요. 첫날에는 밥 먹고 나서 뭘 해야 할지 몰라 멀뚱멀뚱 앉아 있었어요. 둘째 날부터 운동장에 나가 피구를 했어요. 셋째 날에는 교실에서 젠가 대회가 열렸어요. 일주일이 지나니 폰 생각이 별로 안 났어요. 담임 선생님은 "밥 먹는 속도가 빨라지고 대화가 늘었다"고 하셨어요. 우리 반은 이 실험을 한 달 더 하기로 투표했어요.',
  },
  {
    ...
    body: '도서관 입구에 신간 코너가 새로 생겼어요. 이번 달에는 추리 소설 열 권, 과학 만화 여섯 권, 그림책 다섯 권이 들어왔어요. 사서 선생님은 학생들이 신청한 책을 우선으로 샀다고 하셨어요. 제일 먼저 빌려 간 책은 탐정 시리즈 3권이었어요. 신간은 한 번에 한 권만 빌릴 수 있고 일주일 안에 돌려줘야 해요. 다음 달 신간 신청은 도서관 앞 상자에 쪽지를 넣으면 돼요. 읽고 싶은 책이 있으면 미리 적어 두세요.',
  },
  {
    ...
    body: '가을 음악회에서 합창부 지휘를 맡은 6학년 친구를 만났어요. 지휘는 음악 선생님이 추천해서 맡게 됐다고 해요. 제일 어려운 점은 "친구들이 서로 다른 박자로 부를 때"라고 했어요. 연습할 때 폰을 보는 친구가 있으면 노래가 흔들려서 연습 시간에는 폰을 가방에 넣기로 다 같이 정했어요. 음악회에서 부를 곡은 세 곡이고 그중 한 곡은 학생들이 직접 골랐어요. 긴장되지 않냐고 묻자 "친구들 얼굴을 보면 괜찮다"고 답했어요.',
  },
  {
    title: '운동장 조회대 벽 그리기 봉사 후기',
    type: 'review',
    tags: ['A', 'phonefree'],
    oneLine: '페인트가 옷에 묻어도 좋았어요',
    body: '토요일 아침에 운동장 조회대 벽 그리기 봉사에 참여했어요. 6학년 열두 명과 선생님 세 분이 모였어요. 밑그림은 미술부가 미리 그려 두었고 우리는 색을 칠했어요. 페인트가 손과 옷에 묻었지만 아무도 신경 쓰지 않았어요. 세 시간 동안 폰을 한 번도 안 봤는데 시간이 금방 갔어요. 완성된 벽에는 책 읽는 아이, 공 차는 아이, 그림 그리는 아이가 있어요. 월요일에 친구들이 벽 앞에서 사진을 찍는 걸 보니 뿌듯했어요.',
  },
  {
    ...
    tags: ['R', 'S'],
    oneLine: '38미터 신기록',
    body: '과학 동아리가 준비한 물로켓 대회가 운동장에서 열렸어요. 6학년 열 팀이 참가했고 페트병과 종이로 직접 로켓을 만들었어요. 물의 양과 공기 압력을 다르게 해서 실험했어요. 가장 멀리 날아간 로켓은 38미터를 기록해 작년 기록을 넘었어요. 발사 순간마다 아이들이 카운트다운을 외쳤어요. 과학 선생님은 "실패한 팀도 왜 실패했는지 적어 오면 점수를 준다"고 하셨어요. 다음 대회는 봄에 열려요.',
  },
  {
    title: '우리 학교 텃밭 배추가 김장이 되기까지의 이야기',
    type: 'review',
    tags: ['R'],
    oneLine: '배추 한 포기의 여행',
    body: '텃밭에서 키운 배추가 김장 김치가 되는 과정을 따라가 봤어요. 9월에 모종을 심고 매주 물을 줬어요. 벌레를 잡느라 애를 먹었지만 농약은 쓰지 않았어요. 11월에 수확한 배추는 급식실로 갔고 학부모 봉사단과 함께 김장을 했어요. 우리는 배추에 양념을 바르는 일을 맡았어요. 손이 빨개졌지만 갓 담근 김치를 밥에 얹어 먹으니 정말 맛있었어요. 남은 김치는 지역 복지관에 전달했어요.',
  },
] as const;
const CARD_TITLES = [
  '한 장으로 보는 폰프리 3원칙',
...
const CARD_BODIES = [
  '첫째, 자기 전에는 폰을 거실에 둬요. 둘째, 공부할 때는 방해금지 모드를 켜요. 셋째, 자동 재생은 꺼요. 이 세 가지만 지켜도 하루 한 시간이 생겨요.',
  ...
  '칭찬 먼저, 질문은 부드럽게, 놀리는 말은 절대 금지예요. 좋은 댓글은 친구를 웃게 해요.',
...
async function main(): Promise<void> {
    ...
    for (const p of personas) {
      ...
      if (chance(0.06)) {
        ...
        await execute('UPDATE posts SET body = CONCAT(body, ?) WHERE id = ?', [
          ' 선생님 말씀대로 어떤 앱을 얼마나 썼는지 더 자세히 적어 봤어요. 다음 주에는 알림을 끄고 사용시간을 기록해서 비교해 보겠어요.',
          postId,
        ]);
      ...
      w.u,
      {
        ...
        body:
          a.type !== 'cardnews' && Array.from(a.body).length < 200
            ? a.body + ' 다음에도 이런 행사가 또 열리면 꼭 참여하고 싶어요.'
  ...
  for (const [wi, plan] of TOPIC_PLAN.entries()) {
    ...
    const poolAgree = shuffle((plan.agree ?? []).map((t, i) => naturalize(t, 'agree', i)));
    const poolDisagree = shuffle((plan.disagree ?? []).map((t, i) => naturalize(t, 'disagree', i)));
  ...
  // 댓글·토론 의견 엄지척: 인기 댓글(베스트·열심 학생 글)에 몰리게 가중 추첨. 포인트는 규칙대로(LIKE_GIVEN 일 10, 댓글당 받은 좋아요 5P 상한)
  {
    const rows = await query<{
      ...
      `SELECT c.id, c.author_id, c.created_at, c.target_type,
              EXISTS(SELECT 1 FROM news_best_opinions b WHERE b.comment_id = c.id) AS best
       FROM comments c WHERE c.status = 'visible' AND c.target_type <> 'council_post'`,
    );
    const weighted: typeof rows = [];
    for (const c of rows) {
      const lv = levelOf.get(c.author_id) ?? 'mid';
      let w = lv === 'high' ? 3 : lv === 'mid' ? 2 : 1;
      if (c.best) w *= 4;
      if (c.target_type === 'news_topic') w *= 2;
      if (R() < 0.08) w *= 6; // 몇 개는 화제의 댓글
      if (R() < 0.012) w *= 20; // 아주 인기 있는 댓글은 반 이상이 눌러요
      for (let k = 0; k < w; k += 1) weighted.push(c);
    }
    let commentLikes = 0;
    for (const p of personas) {
      const n = Math.round(
      ...
      const picked = [...new Map(shuffle(weighted).map((c) => [c.id, c])).values()]
        .filter((c) => c.author_id !== p.u.row.id)
        .slice(0, n);
      for (const c of picked) {
        const base = kst(c.created_at);
        let at = base.add(between(1, 96), 'hour');
        if (at.isAfter(today)) at = today.subtract(between(0, 20), 'hour');
        await like(p.u, 'comment', c.id, c.author_id, at);
        commentLikes += 1;
      }
    }
    console.log(`댓글·의견 엄지척 ${commentLikes}`);
  }
  ...
  // 9) 교사 칭찬·공지·신고
  let bonuses = 0;
  // 지난 주차 칭찬: 열심 학생 상위(개인 배수 큰 순) 6명은 매주 담임이 칭찬(학생 주 50P 상한 안에서)
  const stars = personas
    .filter((p) => p.level === 'high')
    .sort((a, b) => b.likesPerWeek[1] - a.likesPerWeek[1])
    .slice(0, 6);
  for (const wk of WEEKS) {
    for (const [si, p] of stars.entries()) {
      const t = teacherOf(p.u);
      for (const k of [0, 1, 2]) {
        const at = wkAt(wk, 1 + k * 2, 15, (si * 7 + k * 13) % 60);
        await applyPointsSafe({
          ruleCode: 'TEACHER_BONUS',
          userId: p.u.row.id,
          grantedBy: t.row.id,
          amount: k === 0 ? 20 : 15,
          note: pickR(BONUS_REASONS),
          refType: 'teacher_bonus',
          refId: null as unknown as number,
          occurredAt: at.toDate(),
          eventKey: `TEACHER_BONUS:${t.row.id}:${p.u.row.id}:${wk}:${k}`,
        });
        bonuses += 1;
      }
    }
