...
const ARTICLES = [
  {
    ...
    type: 'coverage',
    tags: ['S', 'A'],
    body: '지난 토요일 운동장에서 스포츠데이 배구 결승전이 열렸어요. 5학년 1반과 6학년 1반이 맞붙었고, 학생들이 직접 심판과 기록을 맡았어요. 서브가 넘어갈 때마다 응원 소리가 커졌고 마지막 세트는 듀스까지 갔어요. 결국 6학년이 이겼지만 5학년도 끝까지 포기하지 않아서 모두 박수를 받았어요. 다음 스포츠데이에는 피구 경기도 열린다고 해요. 체육 선생님은 "규칙을 지키며 즐기는 모습이 가장 좋았다"고 말씀하셨어요.',
  ...
  },
  {
    ...
    type: 'interview',
    tags: ['R'],
    body: '사서 선생님께 달빛 도서관 행사에 대해 여쭤보았어요. 달빛 도서관은 저녁에 도서관 불을 은은하게 켜고 책을 읽는 행사예요. 선생님은 "폰 대신 책과 친해지는 시간을 만들고 싶었다"고 하셨어요. 참가한 친구들은 손전등으로 책을 읽는 게 신기했다고 말했어요. 다음 달에는 3학년도 참가할 수 있다고 해요. 신청은 도서관 앞 게시판에서 할 수 있어요. 책을 좋아하는 친구들에게 꼭 추천하고 싶어요.',
  ...
  },
  {
    ...
    type: 'review',
    tags: ['phonefree'],
    body: '우리 반은 지난주 수요일에 폰 없는 하루 챌린지를 했어요. 아침에 폰을 담임 선생님께 맡기고 하루를 보냈어요. 처음에는 손이 심심했는데 점심시간에 친구들이랑 공기놀이를 하니까 시간이 금방 갔어요. 집에 가서도 폰을 안 보고 그림을 그렸어요. 저녁에 엄마가 "오늘 표정이 밝다"고 하셨어요. 다음에는 이틀 연속으로 도전해 보고 싶어요. 친구들도 꼭 한번 해 보면 좋겠어요.',
